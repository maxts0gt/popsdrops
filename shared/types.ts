// ---------------------------------------------------------------------------
// Platform-agnostic types and constants for PopsDrops
// Shared between Next.js web app and Expo mobile app
// ---------------------------------------------------------------------------
...
// Niche string keys for i18n (resolved via t())
export const NICHE_KEYS: Record<Niche, string> = {
  beauty: "niche.beauty",
  fashion: "niche.fashion",
  food: "niche.food",
  travel: "niche.travel",
  tech: "niche.tech",
  ...
  parenting: "niche.parenting",
  automotive: "niche.automotive",
  home: "niche.home",
  health: "niche.health",
...
export const MARKET_REGION_CODES: Record<Market, string> = {
...
// Content format string keys for i18n (resolved via t())
export const FORMAT_KEYS: Record<ContentFormat, string> = {
  short_video: "format.shortVideo",
  long_video: "format.longVideo",
  story: "format.story",
  photo_post: "format.photoPost",
  reel: "format.reel",

...
comment on function app_private.enforce_campaign_member_creator_capacity() is
  'Blocks accepted creator rows from exceeding paid service-fee creator capacity, including paid checkout sessions whose scope lives on the matching invoiced event.';

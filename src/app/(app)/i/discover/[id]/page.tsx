...
export default function CampaignDetailPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl p-4 pb-40 lg:p-6 lg:pb-6">
        ...
        {(campaign.usage_rights_duration ||
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-1 text-sm text-muted-foreground">
              {campaign.usage_rights_duration && (
                <span>{t("usage.duration", { value: formatSnakeCase(campaign.usage_rights_duration) })}</span>
              )}
              {campaign.usage_rights_territory && (
                <span>{t("usage.territory", { value: formatSnakeCase(campaign.usage_rights_territory) })}</span>
              )}
              <span>
      ...
      {!applied && (
        <div className="fixed inset-x-0 bottom-[calc(env(safe-area-inset-bottom)+56px)] z-30 border-t border-border bg-card/95 p-4 backdrop-blur-sm lg:hidden">
          <div className="flex items-center gap-3">
            <div className="flex-1">
              <p className="text-[11px] text-muted-foreground/70">{t("apply.budgetPerCreator")}</p>
